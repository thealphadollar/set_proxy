...
We are grateful that you considered contributing to set_proxy_kgp. Please follow the below guidelines for contribution.
...
Please join the [gitter channel](https://gitter.im/set_proxy/Lobby) for communication regarding the project. No personal communication will be entertained :)